        ...
        <div className={` h-screen  bg-gray-900 `}>
                    ...
                    <div key={i} className="flex-wrap bg-gray-100 rounded p-4">
                        ...
                        <div className="mt-4 w-[200px]">
                            ...
                            <div className="flex items-center mb-2">
                                ...
                                <p className="ml-2">{item.price.toLocaleString()} so`m</p>
                            </div>
                            <div className="flex items-center mb-2">
            ...
            <Modal show={isModalOpen} onHide={handleCloseModal}>
                ...
                <Modal.Body>
                    ...
                    {carParts.length === 0 ? <h3>Iltimos ehtiyot qism qo'shing</h3> :
                        <select
                            className={'form-select'}
                            value={carPartId}
                        ...
                        >
                            ...
                            {carParts?.map((item) => (
                                <option className={"font-mono"} key={item.id} value={item.id}>
                                    {item.name}
                                </option>
                            ))}
                        </select>}
