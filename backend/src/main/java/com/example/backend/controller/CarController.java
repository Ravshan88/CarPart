...
public class CarController {
    ...
    public HttpEntity<?> deleteCar(@PathVariable UUID id, @RequestParam UUID attachmentId, @RequestParam String attachmentName) {
        return carService.deleteCar(id,attachmentId,attachmentName);
    }
}
