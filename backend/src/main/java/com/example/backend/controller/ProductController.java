...
public class ProductController {
    ...
    @DeleteMapping
    public void deleteProduct(@RequestParam UUID id, @RequestParam UUID attachmentId, @RequestParam String attachmentName) {
        productService.deleteProduct(id, attachmentId, attachmentName);
    }
}
